...
updated: '2026-09-21T13:43:55.566+08:00'
---
# 1、确认机型是否支持
...
固件原链接因作者厌恶免费资源被第三方在咸鱼收取手工费代刷，故而选择撤除网盘链接表示抵制（无法理解的逻辑，不应该是越免费越公开，贩子才越没法通过信息差赚钱吗？）。所以目前互联网无法获取到作者本人发布的原始文件了。
...
这个包的安卓系统是为原来[kdroid](https://kdroid.club)系统的延续和第三方后续开发版本，总的来说体验与原kdroid没有本质区别，各方面体验均类似。仅去除了kdroid 160元一个的收费验证，并且做了些细节上的细微调整。

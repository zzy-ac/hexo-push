...
| ![img](https://img.m-l.cc/2024-08-12-66b9adbb2510f.webp) | ![img](https://img.m-l.cc/2024-08-12-66b9af7167971.webp) | ![img](https://img.m-l.cc/2024-08-12-66b9b03d2b0b9.webp) |
| --------------------------------------------------------------------------- | --------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
|                                                                             |                                                                             |                                                                             |
...
|                | 描述                                                                                                                    | 预览                                                                          |
| -------------- | ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| 划词翻译       | 选中需要翻译的文本之后，按下划词翻译快捷键即可                                                                          | ![img](https://img.m-l.cc/2024-08-12-66b9ac969fd33.webp) |
| 输入翻译       | 按下输入翻译快捷键，输入需要翻译的文本，`Enter` 键翻译                                                                  | ![img](https://img.m-l.cc/2024-08-12-66b9adc78095d.webp) |
| 插件调用       | 选中需要翻译的文本之后，点击插件图标即可，详情见[插件调用](https://pot.pylogmon.com/docs/tutorial/config/plugin_config) | ![img](https://img.m-l.cc/2024-08-12-66b9ac32992c5.webp) |
| 剪切板监听模式 | 打开翻译窗口，启动剪切板监听模式，复制想要翻译的内容即可                                                                | ![img](https://img.m-l.cc/2024-08-12-66b9af77e27c7.webp) |
| 截图OCR        | 按下快捷键，框选需要识别区域即可                                                                                        | ![img](https://img.m-l.cc/2024-08-12-66b9af40dbb32.webp) |
| 截图翻译       | 按下快捷键，框选需要识别区域即可                                                                                        | ![img](https://img.m-l.cc/2024-08-12-66b9ae04718b9.webp) |

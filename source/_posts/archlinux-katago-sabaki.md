...
![image-20220811165920792](https://img.m-l.cc/2024-08-12-66b9af7c5ae55.webp)

之后，解压缩katago的压缩包，将文件名为kata1-b60c320-s6372316160-d2964581281.bin.gz(kata1-后面的字符可能随版本不同有所不同，请自行辨别)放入文件夹下。

![image-20220811171236578](https://img.m-l.cc/2024-08-12-66b9ac8588967.webp)在终端打开该文件夹，执行如下指令：
...
![image-20220811171149406](https://img.m-l.cc/2024-08-12-66b9af05b85bb.webp)
...
![image-20220811171622719](https://img.m-l.cc/2024-08-12-66b9adf66ac82.webp)

3. 新增配置如下图
![image-20220811171713071](https://img.m-l.cc/2024-08-12-66b9ac54496a6.webp)

## 完成

之后你就可以自由的在Sabaki中使用Katago引擎进行围棋训练了。

![image-20220811172125906](https://img.m-l.cc/2024-08-12-66b9ad04af0c5.webp)

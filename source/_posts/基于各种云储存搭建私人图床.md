...
{% fb_img https://cloudpic.dmnb.cf/images/2021/10/22/Screenshot_2021-10-22-22-00-55-0822382073_EDIT_1634911298694_22:02:01.png 网站-添加站点 %}

在弹出的窗口中，输入你的域名，选择好对应的php版本

{% fb_img https://cloudpic.dmnb.cf/images/2021/10/22/Screenshot_20211022220752_22:08:34.jpg Screenshot_20211022220752.jpg %}
...
```
{% fb_img https://cloudpic.dmnb.cf/images/2021/10/22/Screenshot_2021-10-22-22-22-25-1933548049_22:23:05.png Screenshot_2021-10-22-22-22-25-1933548049.png %}
看到如上结果后表示已经完成了

之后回到宝塔面板的站点根目录，刷新页面，就会看到一个`PicUploader`项目所包含的全部文件
{% fb_img https://cloudpic.dmnb.cf/images/2021/10/22/Screenshot_2021-10-22-22-21-43-0840153413_22:22:09.png Screenshot_2021-10-22-22-21-43-0840153413.png %}

### 配置站点

在宝塔面板左侧菜单栏，点击  `网站`，找到你添加的站点，点击该站点右侧的  `设置`
{% fb_img https://cloudpic.dmnb.cf/images/2021/10/22/Screenshot_2021-10-22-22-26-26-1423592107_EDIT_1634912845049_22:27:41.png Screenshot_2021-10-22-22-26-26-1423592107_EDIT_1634912845049.png %}

#### 设置SSL

这个是可选，不过建议设置。如下图选择  `SSL`-  `Let’s Encrypt`，填写管理员邮箱，勾选你的域名，然后点击申请即可：

{% fb_img https://cloudpic.dmnb.cf/images/2021/10/22/Screenshot_2021-10-22-22-28-49-1766383197_EDIT_1634912964333_EDIT_1634912999721_22:30:18.png Screenshot_2021-10-22-22-28-49-1766383197_EDIT_1634912964333_EDIT_1634912999721.png %}

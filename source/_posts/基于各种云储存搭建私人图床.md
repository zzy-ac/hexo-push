...
![Screenshot_2021-10-22-22-00-55-0822382073_EDIT_1634911298694_22_02_01](https://img.m-l.cc/2024-08-12-66b9c05422640.webp)

在弹出的窗口中，输入你的域名，选择好对应的php版本

![Screenshot_20211022220752_22_08_34](https://img.m-l.cc/2024-08-12-66b9c08b93ada.webp)
...
```
![1723449515324.webp](https://img.m-l.cc/2024-08-12-66b9c0bd868f6.webp)

看到如上结果后表示已经完成了

之后回到宝塔面板的站点根目录，刷新页面，就会看到一个`PicUploader`项目所包含的全部文件
![1723449567296.webp](https://img.m-l.cc/2024-08-12-66b9c0e58ecda.webp)

### 配置站点

在宝塔面板左侧菜单栏，点击  `网站`，找到你添加的站点，点击该站点右侧的  `设置`
![1723449601688.webp](https://img.m-l.cc/2024-08-12-66b9c10912912.webp)

#### 设置SSL

这个是可选，不过建议设置。如下图选择  `SSL`-  `Let’s Encrypt`，填写管理员邮箱，勾选你的域名，然后点击申请即可：

![1723449632537.webp](https://img.m-l.cc/2024-08-12-66b9c127b5861.webp)
